import type { CollectionMetadata as CollectionMeta, TokenMetadata } from '@kodadot1/hyperdata'
...
export interface CollectionFloorPrice { floorPrice: { price: string }[] }
