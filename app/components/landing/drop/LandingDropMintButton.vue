...
<template>
  <UButton class="bg-black text-white rounded-full px-6 py-3 md:px-4 md:py-[10px] text-sm hover:bg-gray-900 transition w-full md:w-auto" @click="handleMintButtonClick">
    {{ mintButtonLabel }}
  </UButton>
</template>
