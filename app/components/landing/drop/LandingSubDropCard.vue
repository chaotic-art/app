...
<template>
  <div class="grid grid-cols-1 md:grid-cols-2 rounded-xl h-auto md:h-[440px] overflow-hidden border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
