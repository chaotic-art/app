...
<template>
  <section class="pt-8 md:pt-16 md:px-0 bg-white dark:bg-neutral-900">
    ...
    <div class="">
      ...
      <div class="flex justify-center mt-6 md:mt-8">
        <UButton class="bg-white dark:bg-neutral-800 text-black dark:text-white border border-gray-300 dark:border-neutral-700 rounded-full px-6 py-2 md:px-8" :to="`/${prefix}/explore/collectibles`">
