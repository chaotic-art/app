...
<template>
  <NuxtLink :to="`/${prefix}/u/${address}`" class="flex items-center gap-2 rounded-full pr-4 w-fit bg-gray-100 dark:bg-neutral-800 min-w-0" :class="{ '!bg-transparent': transparentBackground, 'p-1.5': !transparentBackground }">
